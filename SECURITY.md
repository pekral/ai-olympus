...
| `.claude/settings.local.json` — deletes hook handlers pointing at the removed `bash-guard` | `install` (unconditional) | a matching handler is present |
