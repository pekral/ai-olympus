...
- Apply `@rules/compound-engineering/general.md` *Label tracker issues, and keep the labels true* to every issue this skill creates.
...
1. Create only the approved missing labels and draft issues. Apply one content label to each created issue per `@rules/compound-engineering/general.md` *Label tracker issues, and keep the labels true*.
