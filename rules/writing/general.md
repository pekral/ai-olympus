...
- **Active voice, named actor.** Write *`talos` opens the pull request*, never *the pull request is opened*. The passive hides who acts, and in an agent pipeline the actor is the load-bearing part.
