...
| Rule | What it governs | Scope |
|---|---|---|
| [`compound-engineering/orchestration.md`](../rules/compound-engineering/orchestration.md) | Dispatch-time mechanics — adaptive routing, context efficiency, savings mode, consent levels, the Bash capability boundary, audit trail, temporary-file hygiene, orchestrator turn discipline | Orchestration |
