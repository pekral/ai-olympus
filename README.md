...
| `code-review/general.md`                | Code review constraints, gates, and the two-part output contract                                                                                                  | Reference     |
| `code-review/core-analysis.md`          | Code review — the Core Analysis walk-through: the catalog of what counts as a finding on a diff                                                                    | Reference     |
| `code-review/review-process.md`         | Code review — the passes the review runs and how it reports: refactoring/DRY, coverage gate, findings verification, output rules                                   | Reference     |
